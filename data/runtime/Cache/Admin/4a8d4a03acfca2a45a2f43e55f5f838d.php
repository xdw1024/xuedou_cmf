...
<head>
	...
	<link href="/thcmf/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
    <link href="/thcmf/public/simpleboot/css/simplebootadmin.css" rel="stylesheet">
    <link href="/thcmf/public/js/artDialog/skins/default.css" rel="stylesheet" />
    <link href="/thcmf/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
    <style>
	...
	<!--[if IE 7]>
	<link rel="stylesheet" href="/thcmf/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
	<![endif]-->
    ...
    <script src="/thcmf/public/js/jquery.js"></script>
    <script src="/thcmf/public/js/wind.js"></script>
    <script src="/thcmf/public/simpleboot/bootstrap/js/bootstrap.min.js"></script>
    <script>
    	$(function(){
...
<body>
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<?php if(!empty($site_admin_url_password)): ?><span class="help-block">后台地址：<span id="js-site-admin-url"><?php echo sp_get_host();?>/thcmf?g=admin&upw=<?php echo C('SP_SITE_ADMIN_URL_PASSWORD');?></span></span><?php endif; ?>
									</div>
								</div>
								<div class="control-group">
	...
	<script type="text/javascript" src="/thcmf/public/js/common.js"></script>
	<script>
		/////---------------------
		$(function(){
