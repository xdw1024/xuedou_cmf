<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
    ...
    <![endif]-->
	<link rel="icon" href="/xuedou_cmf/themes/simplebootx/Public/assets/images/favicon.ico" type="image/x-icon">
	<link rel="shortcut icon" href="/xuedou_cmf/themes/simplebootx/Public/assets/images/favicon.ico" type="image/x-icon">
    <link href="/xuedou_cmf/themes/simplebootx/Public/assets/simpleboot/themes/simplebootx/theme.min.css" rel="stylesheet">
    <link href="/xuedou_cmf/themes/simplebootx/Public/assets/simpleboot/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
    <link href="/xuedou_cmf/themes/simplebootx/Public/assets/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
	<!--[if IE 7]>
	<link rel="stylesheet" href="/xuedou_cmf/themes/simplebootx/Public/assets/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
	<![endif]-->
	<link href="/xuedou_cmf/themes/simplebootx/Public/assets/css/style.css" rel="stylesheet">
	<style>
		...
		<link href="/xuedou_cmf/themes/simplebootx/Public/assets/css/slippry/slippry.css" rel="stylesheet">
		<style>
...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="/xuedou_cmf/"><img src="/xuedou_cmf/themes/simplebootx/Public/assets/images/logo.png"/></a>
 ...
 $effected_id="main-menu"; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="li-class" ; $style="nav"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("main",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
		...
		<ul class="nav pull-right" id="main-menu-user">
			...
			<li class="dropdown user login">
	            ...
	            <img src="/xuedou_cmf/themes/simplebootx/Public/assets/images/headicon.png" class="headicon"/>
          	...
          	<li class="dropdown user offline">
	            <a class="dropdown-toggle user" data-toggle="dropdown" href="#">
	           		<img src="/xuedou_cmf/themes/simplebootx/Public/assets/images/headicon.png" class="headicon"/>登录<b class="caret"></b>
	            </a>
	            <ul class="dropdown-menu pull-right">
				...
				<div class="header">
					<div class="item-image">
						<a href="<?php echo leuu('article/index',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>">
							<?php if(empty($smeta['thumb'])): ?><img src="/xuedou_cmf/themes/simplebootx/Public/assets/images/default_tupian1.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
							<?php else: ?> 
...
var GV = {
   ...
   <script src="/xuedou_cmf/themes/simplebootx/Public/assets/simpleboot/bootstrap/js/bootstrap.min.js"></script>
   <script src="/xuedou_cmf/public/js/frontend.js"></script>
<script>
$(function(){
...
<script src="/xuedou_cmf/themes/simplebootx/Public/assets/js/slippry.min.js"></script>
<script>
$(function() {
